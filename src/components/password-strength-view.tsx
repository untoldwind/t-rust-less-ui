...
export const PasswordStrengthView: React.FC<PasswordStrengthProps> = React.memo(
  ({ passwordStrength }) => {
    ...
    return (
      <Tooltip
        ...
        content={
          passwordStrength && (
            <PasswordStrengthDetails strength={passwordStrength} />
          )
        }
      >
        <ProgressBar
          ...
          stripes={false}
          animate={false}
          value={passwordStrength ? passwordStrength.entropy / 55.0 : 1.0}
        />
      </Tooltip>
    );
  },
